...
# Prerequisites 
1. GPIO configuration are based on `ESP32-CAM AI-THINKER` microcontroller with a `OV2640` camera.
...
> - The main code was based on the [AsyncWebCamera.cpp](https://gist.github.com/me-no-dev/d34fba51a8f059ac559bf62002e61aa3) that use an asyncronous web server to handle the camera response.
